...
const PRINCIPLES = [
  ...
  {
    title: 'Shipped, not someday',
    body: 'These aren’t concepts. Three products are live at their own domains, on real infrastructure, used today — with more in the forge.',
  },
]
...
function Logomark({ size = 34 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" aria-hidden="true" className="logomark">
      ...
      <path
        d="M12 44 L26 20 L32 30 L38 20 L52 44"
        fill="none"
        stroke="url(#lm-molten)"
        strokeWidth="4.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path d="M22 44 L42 44" stroke="url(#lm-molten)" strokeWidth="4.5" strokeLinecap="round" opacity="0.55" />
      <circle cx="32" cy="14" r="3.2" fill="#FFC24B" />
    </svg>
  )
}
...
function Wordmark() {
  return (
    <a href="#top" className="wordmark" aria-label="Rift Foundry — home">
      <Logomark />
      <span className="wordmark__text">
        Rift<span className="wordmark__amp">·</span>Foundry
      </span>
    </a>
  )
}
...
function ContourField() {
  // Decorative Rift-Valley contour lines behind the hero.
      ...
      <section className="hero">
        ...
        <div className="hero__inner">
          ...
          <h1 className="hero__title" data-reveal>
            We forge software in the{' '}
            <span className="molten">Great Rift Valley</span> — built to work anywhere.
          </h1>
          <p className="hero__lede" data-reveal>
            Rift Foundry designs, builds and runs its own software products end-to-end. Practical
            tools for real people and real businesses — shipped to production, not left on a slide.
          </p>
        ...
        <div className="studio__grid">
          <div className="studio__intro" data-reveal>
            ...
            <h2 className="section__title">
              A foundry, not an agency.
            </h2>
            <p className="studio__body">
              Rift Foundry is an independent studio that builds and owns its products — from the first
              sketch to the servers they run on. We take small, sharp ideas and forge them into things
              people actually use.
            </p>
            <p className="studio__body">
              The name is literal: these products are built in the Great Rift Valley and made to hold
              up anywhere in the world. Rooted here, useful everywhere.
            </p>
          </div>
      ...
      <footer className="footer">
        <div className="footer__inner">
          ...
          <p className="footer__note">
            Forged in the Great Rift Valley · Nairobi, Kenya · © {year}
          </p>
        </div>
      </footer>
    </div>
